...
export const GUIDES: Guide[] = [
  ...
  ], faqs: [{ question: "¿Puedo cambiar el orden de los PDF?", answer: "Sí. Puedes ordenar los archivos antes de iniciar la combinación." }, { question: "¿Cuesta dinero unir PDF?", answer: "No. La herramienta es gratuita y no requiere registro ni suscripción." }] },
